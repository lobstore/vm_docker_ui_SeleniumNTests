...
- **Описание**: При регистрации нового пользователя с полем emeil без доменного расширения (example@gmail) проходит успешная регистрация.
- **Шаги для воспроизведения**:
	1. Перейти на страницу "Sign Up".
...
- **Описание**: Включение функции Remember me при ходе не пользователя в системе после закрытия браузера.
- **Шаги для воспроизведения**:
...
- **Фактическое поведение**: На панели навигации присутствуют кнопки "Log In" и "Sign Up", при переходе на страницу "Log In" пользователю предожено снова ввести учетные данные.